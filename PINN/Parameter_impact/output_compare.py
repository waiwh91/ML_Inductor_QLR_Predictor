...
simulated_50 = pd.read_csv("simulator_output_data/csv_50.csv").to_numpy()
simulated_100 = pd.read_csv("simulator_output_data/csv_100.csv").to_numpy()
...
df_50.to_csv("data_compare/compare_50.csv", index=False)
...
df_50.to_csv("data_compare/compare_100.csv", index=False)
