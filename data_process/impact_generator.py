...
def generate_50_percent():
    ...
    # print(test_dataframe_50)
    test_dataframe_50.to_csv("Parameter_impact/generated_parameters/raw_50.csv", index=False)
...
def generate_100_percent():
    ...
    # print(test_dataframe_50)
    test_dataframe_100.to_csv("Parameter_impact/generated_parameters/raw_100.csv", index=False)
