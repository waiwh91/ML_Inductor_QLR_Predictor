...
class PINNTransformer(nn.Module):
    def __init__(self, input_dim=7, output_dim=2, d_model=128, nhead=8, num_layers=2, dim_feedforward=512, dropout=0.1):
...
def test(model, data):
    ...
    dataframe.to_csv("training_csv/output.csv", index=False)
